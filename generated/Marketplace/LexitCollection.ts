...
export class LexitCollection__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class LexitCollection extends ethereum.SmartContract {
  static bind(address: Address): LexitCollection {
    return new LexitCollection("LexitCollection", address);
  }
  ...
  royaltyInfo(
    _tokenId: BigInt,
    _salePrice: BigInt
  ): LexitCollection__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new LexitCollection__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    ...
    return ethereum.CallResult.fromValue(
      new LexitCollection__royaltyInfoResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
